...
import { MdHome, MdLensBlur, MdRefresh } from 'react-icons/md';
...
const QuizResult = ({ userAnswer, len }: QuizResultProps) => {
  ...
  return (
    <>
      <section className="flex flex-col max-w-2xl p-2 mx-auto md:gap-5 md:w-full">
        <div className="flex flex-col items-center text-xl justifity-center md:mt-10">
          <div className="flex p-6 mx-auto text-3xl font-bold text-gray-700">
            퀴즈 결과
          </div>
          <div className="p-2 mb-10 text-4xl text-center md:text-4xl">
            <p
              className={`${
        ...
        <div className="flex flex-col items-center mt-6 md:mt-10">
          <div
            className="flex items-center justify-center w-full max-w-xl p-2 m-2 text-teal-700 border border-teal-500 rounded-md cursor-pointer hover:text-white hover:bg-teal-500 md:w-2/3 md:text-xl md:p-5 text-md text-bold"
            onClick={() => router.back()}
          >
            <MdRefresh />
